...
import { View, StyleSheet, Pressable, ScrollView, TextInput, Modal, Button, Text, TouchableOpacity } from 'react-native';
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Modal animationType="slide" transparent={true} visible={modalVisible} onRequestClose={handleDiscard}>
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <TextInput
              ...
              style={styles.input}
            />
            <TextInput placeholder="Data" value={formData.date} editable={false} style={styles.input} />
            <TextInput
...
const styles = StyleSheet.create({
  ...
  footer: { height: 150, alignItems: 'center', justifyContent: 'space-around', flexDirection: 'row' },
  iconButton: { alignItems: 'center', justifyContent: 'center' },
  recordButton: { width: 60, height: 60, borderRadius: 60, borderWidth: 2, borderColor: 'gray', alignItems: 'center', justifyContent: 'center' },
  ...
  input: { height: 40, borderColor: 'rgba(0, 0, 0, 0.4)', borderWidth: 1, borderRadius: 6, marginBottom: 12, paddingHorizontal: 10 },
